...
public class Piso4 implements Screen {
    ...
    private final boolean touchUp    = false;
    private boolean touchDown  = false;

    public Piso4(Main juego) {
        this.juego = juego;
        ...
        // Fondo
        oficinaTexture = new Texture("fondoOfi/fondoOfi3.jpg");
        ...
        Gdx.input.setInputProcessor(stageUI);  // ← recuerda usar InputMultiplexer si tienes más procesadores
...
// Botón derecha
        ...
        btnRight.setPosition(40 + 80 + 40, 120);  // 160, 120

// Calculamos el centro entre izquierda y derecha
        float centerX = (btnLeft.getX() + btnRight.getX() + btnRight.getWidth()) / 2f - 40f;  // -40 porque btnDown mide 80 de ancho
...
// Botón abajo (centrado debajo)
        ...
        btnDown.setPosition(centerX, 120 - 80 - 20);   // 20 píxeles de separación debajo
